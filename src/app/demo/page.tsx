...
export default async function DemoStudio() {
  ...
  assertDemoStorage();
  const { counts, qr } = await demoSnapshot(await getDb());
  ...
  return (
    <main id="main" className="demo-studio">
      <header>
        ...
        <p>
          This is the real application with a separate local sample database. No
          real members, messages, stock or commercial commitments are created.
        </p>
      </header>
