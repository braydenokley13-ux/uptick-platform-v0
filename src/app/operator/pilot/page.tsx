    ...
    <Shell actor={actor} active="pilot" name={run?.name || "Pilot operations"}>
      <div className="network-operations">
        <PageHeading
          ...
          title="Today’s pilot work."
          description="Confirm the promise, deal with failures, and record what actually happened."
        />
        <nav className="network-tabs" aria-label="Pilot operations">
          <Link href="#today">Today</Link>
          <Link href="#run">Pilot run</Link>
        ...
        {run && detail && (
          <>
            <div className="network-metrics">
              ...
              />
              <Metric
                label="PAID LOAD GUIDANCE"
                value={`${Math.round(Number(run.paid_load_guidance) * 100)}%`}
            ...
            <section id="run" className="panel network-panel">
              ...
              <details>
                ...
                >
                  ...
                  {[
                    ...
                    ["partnerDistribution", "Partner distribution plan agreed"],
                    [
                      "privacyIdentity",
              ...
              <details>
                ...
                <p>
                  Joining and promotional consent are separate. Admission checks
                  four weeks of confirmed supply. Starting the run freezes the
                  evaluation cohort.
                </p>
            ...
            <section id="economics" className="panel network-panel">
              ...
              <p>
                ...
                recovery liquidity and retail value separately. An allowance or
                reservation is not an expense.
              </p>
              ...
              <details>
                ...
                {detail.ledger.map((e) => (
                  <article key={e.id}>
                    <p>
                      {String(e.occurred_on).slice(0, 10)} · {label(e.category)}{" "}
                      · {money(e.amount)} · {e.basis} · {e.payer} → {e.payee}
                    </p>
                    <p>{e.evidence}</p>
        ...
        <section className="panel network-panel">
          <details open={!run}>
            ...
            <p>
              First create the Market Cell, approved supply and partner sources.
              Choose a Monday, record accountable people, then confirm all four
              weeks before accepting members.
            </p>
        ...
        <section className="panel network-panel">
          <details>
            ...
            <p>
              New records begin as internal. Record evidence before designating
