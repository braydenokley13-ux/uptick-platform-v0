...
| HOSTED COMMISSIONING               | YELLOW for demo; normal commissioning remains separate | Build and private schema complete; runtime connection and hosted journey pending.                                               |
