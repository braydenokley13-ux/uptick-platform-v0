...
The exact source, migration checksums, destinations and commissioning gates are recorded in [PILOT_RELEASE_CANDIDATE.md](PILOT_RELEASE_CANDIDATE.md). This is a reviewable release specification, not a record of a deployment already performed.
